...
function Header({toggleDarkMode, isOpen, onClose}) {
    ...
    return (
        <div className="header pt-2">
            ...
            {/* start header-info  */}
            <div
                className="info w-full mt-44 lg:h-full flex flex-wrap flex-col lg:flex-row justify-around items-center ">
                <div
                ...
                >
                    <div className="hello flex items-end relative ">
                        ...
                        <span
                            className="absolute bottom-1  left-[104%] xl:left-[9.5vw] mt-1 h-3 w-3 bg-secondary rounded-full"></span>
                    ...
                    <div className="fullname relative h-32  mt-4 ">
                        ...
                        <div
                            className="relative left-[42%] xl:left-[4vw] 2xl:left-[7vw] bottom-[84px] lg:bottom-[104px]">
                ...
                >
                    <div
                        className="border-img absolute border-4 border-secondary w-full md:w-9/12 lg:w-4/12 h-[280px] lg:h-[330px] left-[7vw] md:left-[12vw] lg:left-[19vw] top-10 rounded-xl"></div>
                    <img
                        src={myImg}
